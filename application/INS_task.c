...
//		for(int i = 0;i < 3;i++)
//		{
//			if((INS_gyro[i] > -0.005f) && (INS_gyro[i] < 0.005f))
//			{
//				INS_gyro[i] = 0;
//			}
//		}
...
//			
//			YawAngle = INS_angle[0]*57.3f;
//			PitchAngle = INS_angle[1]*57.3f;
//			RollAngle = INS_angle[2]*57.3f;
//			
//			//陀螺仪开机校准
////			{
...
//    if (bmi088_real_data.status & (1 << MPU_MOT_BIT))
//    {
//        (*offset_time_count) = 0;
//        return;
//    }

//    if (bmi088_real_data.status & (1 << MPU_DATA_READY_BIT))
//    {
